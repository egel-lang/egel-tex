...
%       \affaddr{Leading from Behind, the Netherlands}\\
       \email{marco.devillers@gmail.com}
}
\maketitle
...
This is at heart an inductive argument which relies on a
...
of redexes, conforming to the translations of the right-hand-side of
...
The Egel interpreter uses a runtime a mapping of the above
...
code comprising of simple graph manipulation instructions.
...
reference counted objects, \code{malloc} and \code{new} are 
completely avoided. However, the major drawback is
